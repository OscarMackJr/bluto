...
| Metadata | Value |
|---|---|
| Document ID | BLUTO-OPS-TRACE-001 |
| Artifact ID | ART-BLUTO-OPS-TRACE-001-v1.1.0 |
| Version | 1.1.0 |
| Status | Baselined |
...
| Depends On | BLUTO-BASE-GOV-001, BLUTO-BASE-GOV-002, BLUTO-BASE-GOV-004, BLUTO-BASE-STD-001, BLUTO-BASE-STD-002, BLUTO-BASE-STD-003, BLUTO-BASE-STD-004, BLUTO-ARCH-TRACE-001, BLUTO-TEST-TRACE-001, BLUTO-DOM-REVIEW-001 |
| Supersedes | None |
...
Every deployable maps to source module, artifact digest, infrastructure definition, workload identity, contracts, migrations, tests, dashboards, alerts, runbooks, backup plan, owner, and SLO. Release manifests provide end-to-end provenance.
