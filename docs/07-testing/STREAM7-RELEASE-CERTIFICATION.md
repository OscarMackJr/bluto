...
| Metadata | Value |
|---|---|
| Document ID | BLUTO-TEST-RELEASE-001 |
| Artifact ID | ART-BLUTO-TEST-RELEASE-001-v1.1.0 |
| Version | 1.1.0 |
| Status | Baselined |
...
| Depends On | BLUTO-BASE-GOV-001, BLUTO-BASE-GOV-002, BLUTO-BASE-GOV-004, BLUTO-BASE-STD-001, BLUTO-BASE-STD-002, BLUTO-BASE-STD-003, BLUTO-BASE-STD-004, BLUTO-TEST-REVIEW-001, BLUTO-TEST-CONSISTENCY-001, BLUTO-DOM-REVIEW-001 |
| Supersedes | None |
...
Stream 7 is certified as the authoritative verification baseline for Bluto v1.
