# AI Repository Consumption Rules

| Metadata | Value |
|---|---|
| Document ID | BLUTO-AI-CONTEXT-001 |
| Artifact ID | ART-BLUTO-AI-CONTEXT-001-v1.1.0 |
| Version | 1.1.0 |
| Status | Baselined |
...
Agents read in dependency order: authority and status; Stream 1 governance; Stream 2 domain; Stream 3 architecture; Stream 4 contracts; Stream 5 security; Stream 6 engineering; Stream 7 testing; Stream 8 DevOps; then the assigned work package.

Only Baselined or explicitly Approved documents are normative. Superseded documents are historical. Conflicts stop generation and create an architecture issue.

Context packets include stable document IDs, exact sections, requirements, acceptance tests, prohibited interpretations, and artifact scope. Agents do not rely on conversational memory as authority.
