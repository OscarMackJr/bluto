# AI Factory Operating Policy

| Metadata | Value |
|---|---|
| Document ID | BLUTO-AI-POLICY-001 |
| Artifact ID | ART-BLUTO-AI-POLICY-001-v1.1.0 |
| Version | 1.1.0 |
| Status | Baselined |
...
AI access is least privilege and isolated by repository, environment, and task. Agents receive no production secrets or unrestricted production data. Network and tool access is allow-listed.

Context and output retention follow enterprise policy. Generated dependencies require normal supply-chain review. AI findings do not substitute for security incidents, architecture approvals, or legal decisions.
