...
| Metadata | Value |
|---|---|
| Document ID | BLUTO-ENG-RELEASE-001 |
| Artifact ID | ART-BLUTO-ENG-RELEASE-001-v1.1.0 |
| Version | 1.1.0 |
| Status | Baselined |
...
| Depends On | BLUTO-BASE-GOV-001, BLUTO-BASE-GOV-002, BLUTO-BASE-GOV-004, BLUTO-BASE-STD-001, BLUTO-BASE-STD-002, BLUTO-BASE-STD-003, BLUTO-BASE-STD-004, BLUTO-ENG-CERT-001, BLUTO-ENG-CONSISTENCY-001, BLUTO-DOM-REVIEW-001 |
| Supersedes | None |
...
Stream 6 is certified as the authoritative implementation standard for Bluto v1.
