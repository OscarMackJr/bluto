# Dependency and Software Supply Chain Standard

| Metadata | Value |
|---|---|
| Document ID | BLUTO-ENG-SUPPLY-001 |
| Artifact ID | ART-BLUTO-ENG-SUPPLY-001-v1.1.0 |
| Version | 1.1.0 |
| Status | Baselined |
...
Dependencies require an owner, purpose, supported version, license review, vulnerability monitoring, and upgrade policy. Lockfiles are committed. Builds are hermetic where feasible.

Artifacts include SBOM, provenance, checksums, signature, source revision, contract version, migration set, and dependency inventory. Unmaintained or unnecessary packages are removed.
