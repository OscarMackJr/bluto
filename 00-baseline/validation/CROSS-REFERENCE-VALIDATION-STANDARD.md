# Cross-Reference Validation Standard

| Metadata | Value |
|---|---|
| Document ID | BLUTO-BASE-VAL-003 |
| Artifact ID | ART-BLUTO-BASE-VAL-003-v2.0.0 |
| Version | 2.0.0 |
| Status | Baselined |
...
| Depends On | BLUTO-BASE-QG-001, BLUTO-BASE-VAL-001, BLUTO-BASE-VAL-002 |
| Supersedes | None |
...
This standard is the constitutional execution standard for **GATE-03 — Cross-Reference Validation**. It validates constitutional, artifact, release, section, anchor, and external normative reference resolution; orphan, ambiguity, and cycle detection.
