...
| Metadata | Value |
|---|---|
| Document ID | BLUTO-BASE-VAL-001 |
| Artifact ID | ART-BLUTO-BASE-VAL-001-v2.0.0 |
| Version | 2.0.0 |
| Status | Baselined |
...
This standard is the constitutional execution standard for **GATE-01 — Metadata Validation**. It validates mandatory metadata, semantic values, lifecycle, authority fields, dependencies, versions, classification, and publication consistency.
